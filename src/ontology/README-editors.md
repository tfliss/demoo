These notes are for the EDITORS of demoo
...
Make sure you have an ID range in the [idranges file](demoo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [demoo-edit.owl](demoo-edit.owl)

** DO NOT EDIT demoo.obo OR demoo.owl in the top level directory **

[../../demoo.owl](../../demoo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/tfliss/demoo) for details.
 ...
 * [demoo-idranges.owl](demoo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/demoo_terms.txt file
...
Note: the demoo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as demoo.owl and demoo.obo and places
 ...
 * https://github.com/tfliss/demoo/releases
 * https://github.com/tfliss/demoo/releases/new
...
what is in the `owl:versionIRI` of the derived demoo.owl (`data-version` in
demoo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/demoo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/demoo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/tfliss/demoo.svg?branch=master)](https://travis-ci.org/tfliss/demoo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/tfliss](https://travis-ci.org/profile/tfliss)
 2. click the "Sync account" button
 3. Click the tick symbol next to demoo
